 ...
 * @author jinjunliang
 **/
public class CustomMqttEnpointImpl implements MqttEndpoint {
  private static final int MAX_MESSAGE_ID = 65535;

  private static final Logger log = LoggerFactory.getLogger(CustomMqttEnpointImpl.class);
   ...
   */
  public CustomMqttEnpointImpl(NetSocketInternal conn, String clientIdentifier, MqttAuth auth, MqttWill will, boolean isCleanSession, int protocolVersion, String protocolName, int keepAliveTimeoutSeconds) {
    this.conn = conn;
  ...
  public CustomMqttEnpointImpl disconnectHandler(Handler<Void> handler) {
  ...
  public CustomMqttEnpointImpl subscribeHandler(Handler<io.vertx.mqtt.messages.MqttSubscribeMessage> handler) {
  ...
  public CustomMqttEnpointImpl unsubscribeHandler(Handler<io.vertx.mqtt.messages.MqttUnsubscribeMessage> handler) {
  ...
  public CustomMqttEnpointImpl publishHandler(Handler<io.vertx.mqtt.messages.MqttPublishMessage> handler) {
  ...
  public CustomMqttEnpointImpl publishAcknowledgeHandler(Handler<Integer> handler) {
  ...
  public CustomMqttEnpointImpl publishReceivedHandler(Handler<Integer> handler) {
  ...
  public CustomMqttEnpointImpl publishReleaseHandler(Handler<Integer> handler) {
  ...
  public CustomMqttEnpointImpl publishCompletionHandler(Handler<Integer> handler) {
  ...
  public CustomMqttEnpointImpl pingHandler(Handler<Void> handler) {
  ...
  public CustomMqttEnpointImpl closeHandler(Handler<Void> handler) {
  ...
  public CustomMqttEnpointImpl exceptionHandler(Handler<Throwable> handler) {
  ...
  private CustomMqttEnpointImpl connack(MqttConnectReturnCode returnCode, boolean sessionPresent) {
  ...
  public CustomMqttEnpointImpl accept(boolean sessionPresent) {
  ...
  public CustomMqttEnpointImpl reject(MqttConnectReturnCode returnCode) {
  ...
  public CustomMqttEnpointImpl subscribeAcknowledge(int subscribeMessageId, List<MqttQoS> grantedQoSLevels) {
  ...
  public CustomMqttEnpointImpl unsubscribeAcknowledge(int unsubscribeMessageId) {
  ...
  public CustomMqttEnpointImpl publishAcknowledge(int publishMessageId) {
  ...
  public CustomMqttEnpointImpl publishReceived(int publishMessageId) {
  ...
  public CustomMqttEnpointImpl publishRelease(int publishMessageId) {
  ...
  public CustomMqttEnpointImpl publishComplete(int publishMessageId) {
  ...
  @Override
  public CustomMqttEnpointImpl publish(String topic, Buffer payload, MqttQoS qosLevel, boolean isDup, boolean isRetain) {
    return publish(topic, payload, qosLevel, isDup, isRetain, null);
  }

  @Override
  public CustomMqttEnpointImpl publish(String topic, Buffer payload, MqttQoS qosLevel, boolean isDup, boolean isRetain, Handler<AsyncResult<Integer>> publishSentHandler) {
    return publish(topic, payload, qosLevel, isDup, isRetain, this.nextMessageId(), publishSentHandler);
  }

  @Override
  public CustomMqttEnpointImpl publish(String topic, Buffer payload, MqttQoS qosLevel, boolean isDup, boolean isRetain, int messageId, Handler<AsyncResult<Integer>> publishSentHandler) {
  ...
  public CustomMqttEnpointImpl pong() {
