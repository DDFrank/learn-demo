    ...
    public ServletContextInitializer initializer()
    {
        return new ServletContextInitializer()
        {
            ...
            public void onStartup(ServletContext servletContext) throws ServletException {
                servletContext.setInitParameter("tapestry.app-package", "io.frank.learn");
                servletContext.setInitParameter("tapestry.development-modules", "io.frank.learn.services.DevelopmentModule");
