package io.frank.learn.springboot.kafka;
...
public class QuickDemo {
    private static final String SERVE_LIST = "192.168.0.204:9092";
    ...
    private static Map<String, Object> consumerProps() {
        ...
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, SERVE_LIST);
    ...
    private static Map<String, Object> senderProps() {
        Map<String, Object> props = new HashMap<>();
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, SERVE_LIST);
